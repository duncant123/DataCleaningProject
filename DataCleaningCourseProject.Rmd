...
#Get names of columns (vars) we need to average.
avgCols <- names(data2)
# Remove first 4 description names
avgCols <- avgCols[5:length(avgCols)]
...
write.table( tidyoutput, using row.name=FALSE ,file = "./tidyoutput.txt")
```