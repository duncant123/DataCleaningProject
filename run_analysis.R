...
#  0. Set working Dir
#     Assume we are in the working directory
...
#  ASSUMPTION : source is called when you are in the working data directory
#  Assuming the directory structure and file locations are known might not be true in normal practice
